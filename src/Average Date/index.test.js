import averageDate from './index';

test('averageDate', () => {
  expect(averageDate([])).toBe(null);
  expect(averageDate([new Date(Date.UTC(1970, 0, 1))])).toBe(
